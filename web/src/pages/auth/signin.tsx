      ...
      <div className="flex flex-col place-content-center m-auto w-full h-screen">
        <div className="w-1/3 h-3/5 m-auto border border-accent-neutral/50 rounded-xl bg-background shadow-2xl">
            <div className="h-1/4">
              ...
              <h3 className="text-center text-2xl text-white/90 font-semibold">Sign In</h3>
            ...
            <div className="flex flex-col h-3/4 py-8 place-content-start overflow-y-scroll">
              <>
                {Object.values(providers).map((provider, idx) => (
                  <>
                    <AuthProviderBlock key={idx} providerName={provider.name} iconLink={"/providers/google.png"} provider={provider} />
                  </>
                ))}
              </>
            </div>
