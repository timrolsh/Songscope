...
const OAuthLoginBlock: FC<OAuthLoginBlockProps> = ({provider, providerName, iconLink}) => (
    <button
        ...
        className="h-12 md:h-14 mx-5 lg:w-4/5 lg:mx-auto flex flex-row place-content-around py-2 border border-secondary/60 rounded-lg transition delay-[10ms] hover:bg-secondary"
    >
