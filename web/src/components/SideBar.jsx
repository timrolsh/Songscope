...
const LinkStyles = "w-full rounded-md border bg-accent-neutral/5 border-accent-neutral/10 hover:bg-accent-neutral/20 pl-4 transition py-1 hover:-translate-y-0.5";
const SettingsLinkStyles = "rounded-lg hover:bg-accent-neutral/50 transition-all py-2 hover:font-semibold hover:-translate-y-0.5 text-text/90 hover:text-text text-sm font-normal px-2 flex flex-row space-x-2";
...
function renderSettingsBody() {
    return (
        <>
            <div className="flex flex-col">
                <Link className={SettingsLinkStyles} href="/settings/general"> <HiOutlineCog8Tooth className="my-auto text-xl mr-3"/> General</Link>
                <Link className={SettingsLinkStyles} href=""> <MdOutlineCompareArrows className="my-auto text-xl mr-3"/> Integrations</Link>
                <Link className={SettingsLinkStyles} href=""><MdOutlineSecurity className="my-auto text-xl mr-3"/> Privacy</Link>
                <Link className={SettingsLinkStyles} href=""> <MdInfoOutline className="my-auto text-xl mr-3"/>Preferences</Link>
            </div>
        </>
    );
}
    ...
    return (
        <div className="flex flex-col w-1/5 sm:w-1/6 bg-accent-neutral/5 border-r-2 border-accent-neutral/5 h-screen px-3">
            <h1 className="text-text text-2xl font-semibold pt-4 pb-2">
                {
                    variant == "profile" ? "User Profile" : variant == "settings" ? "Settings" : "Dashboard"
                } 
            </h1> 
            ...
            { variant != "settings" && 
                <h3 className="text-xl font-semibold pb-1 text-text/90">
                    {
                        variant == "profile" ? "Favorite Songs" : variant == "settings" ? "Config" : "Top Songs"
                    }
                </h3>
            }
            {
