            ...
            <div className="flex flex-col place-content-between h-full w-2/5"> 
                ...
                <div className="flex flex-row space-x-0 mx-auto my-1">
                    ...
                    <div className="flex flex-col space-y-2.5 mt-3">
                        <div>
                            <h3 className="font-bold text-sm text-text/90">Album: <span className="font-normal italic text-sm text-text/50">Dark Lane Demo Tapes</span> </h3>
                        </div>
                        <div>
                            <h3 className="font-bold text-sm text-text/90">Popularity: <span className="font-normal italic text-sm text-text/50">🔥🔥🔥🔥</span> </h3>
                        </div>
                        <div>
                            <h3 className="font-bold text-sm text-text/90">Released: <span className="font-normal italic text-sm text-text/50">December 13, 2023</span> </h3>
                        </div>
                    </div>
                </div>
            ...
            <div className="flex flex-col divide-y divide-secondary/80 pl-8 w-3/5">
                    ...
                    <div className="overflow-auto pt-2 h-3/4">
                        {
                            [...Array(5)].map((_, idx) => {
                                ...
                                <div className="flex flex-row space-x-2 py-1 pl-1">
                                    <h3 className="font-semibold text-text/90">&gt; TimRolsh123 <span className="italic font-normal">says </span><span className="font-normal text-text/90">"This song is great! Better than his other works..."</span></h3>
                                </div>
                                )
                            })
                        }
                ...
                <div className="h-1/2 text-lg font-bold text-text pt-2">
                    <div className="h-3/4">
                        ...
                        <textarea type="text" name="name" className="text-text/90 p-2 font-normal text-sm bg-secondary/20 rounded-md w-full h-3/5 resize-none"></textarea>
                    </div>
                    <div className="flex flex-row place-content-between">
                        ...
                        <button className="ml-auto bg-secondary/70 hover:bg-secondary text-text/90 hover:text-text/90 rounded-md px-3 py-1">Submit</button>
                    </div>
                </div>
            </div>
        </div>
